...
|4| [Little Boat on the Sea](https://www.facebook.com/hackercup/problem/1956356724467896/)| [PyPy](./Final%20Round/little_boat_on_the_sea.py) | _O(NlogN)_ | _O(NlogN)_ | Medium | | Preorder Traversal (Stack), Tree Ancestors (Binary Jump), Line Sweep, Segment Tree (Lazy Propagation), RMQ |
...
|6| [Temporal Revision](https://www.facebook.com/hackercup/problem/1165177510537433/)| [Python](./Final%20Round/temporal_revision.py) | _O((S + N) * logN + (K + M) * α(N))_ | _O(NlogN)_  | Hard | |  Union Find, DP, Preorder Traversal (Stack), Tree Ancestors (Binary Jump) |
