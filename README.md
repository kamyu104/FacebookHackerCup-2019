...
|6| [Temporal Revision](https://www.facebook.com/hackercup/problem/1165177510537433/)| | _O((S + N) * logN + (K + M) * α(N))_ | _O(NlogN)_  | Hard | |  Union Find, DP, Tree Ancestors (Skip List) |
