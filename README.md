...
|4| [Little Boat on the Sea](https://www.facebook.com/hackercup/problem/1956356724467896/)| [PyPy](./Final%20Round/little_boat_on_the_sea.py) | _O(NlogN)_ | _O(N)_ | Medium | | Preorder Traversal, Stack, Tree Ancestor, Line Sweep, Segment Tree(Lazy Propagation), RMQ |
